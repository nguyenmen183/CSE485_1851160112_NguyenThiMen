...
<html lang="en">
  ...
  <body>
  <h1 style="text-align: center" class="text-success mb-5 mt-3">Chào mừng bạn đến với website CODEPOWER</h1>
  <?php
  ...
  <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 container">
                  <h1 style=text-align:center>Đăng nhập </h1>
                  <div class=" ml-5">
                  <form  class="md-5"style="width:300px; height:200px" action="" method="POST">
